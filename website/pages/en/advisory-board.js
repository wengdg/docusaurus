      ...
      <div className="docMainWrapper wrapper">
        <Container className="mainContainer documentContainer">
          <div style={{paddingLeft: "10px", paddingRight: "10px"}} className="post">
            ...
            <p style={{maxWidth: "100em", padding: "0"}}>The goal of the RadGrad Project is to dramatically improve the undergraduate computer science degree experience by providing students with a better understanding of the diversity of opportunities available in computer science along with access to communities of practice that will enable more students to both find and pursue their passions.</p>

            <p style={{maxWidth: "100em"}}>The goal of the RadGrad Advisory Board is to provide review and feedback on the planned activities of the RadGrad Development Team in order to ensure a good fit with the project's overall goal.</p>

            <p style={{maxWidth: "100em"}}>Our major activities for Academic Year 2018 are the following: (1) Implement instrumentation to assess student engagement with RadGrad: (2) Gather evidence to assess whether students believe RadGrad has a positive impact on their undergraduate experience; (3) Create mechanisms to assess the ability of RadGrad to support retention of women and underrepresented minorities. </p>
            ...
            <p style={{maxWidth: "100em", padding: "0"}}>"Engagement" is a nebulous term. For this project, we want to provide a precise, operational definition. To accomplish this, we are instrumenting the RadGrad environment so that we can track each user's use of the system and abstract low-level interactions into one or more of the following eight high level RadGrad Behaviors: <ol><li>Change outlook: a change in interests, career goals, or degree plan</li><li>Exploration: viewing entries in the career goal, interest, course, user, and/or opportunity explorer</li><li> Planning: changes to the courses and/or opportunities in the Degree Planner</li><li>Verification: submission of completed opportunities </li><li>Reviewing: submission of a course or opportunity review</li><li>Mentorship: visits and interaction with the MentorSpace area</li><li> Leveling Up: achieving the next level</li><li>Complete Plan Achieved: planning at least 100 points in all three ICE categories</li></ol> </p>
            ...
            <p style={{maxWidth: "100em", padding: "0"}}>At the end of the Spring, 2018 semester, we will conduct an experiment in which we will ask students to fill out a questionnaire regarding their undergraduate experience. We will draw our sample of students from two groups: (1) Students who were "engaged" users of RadGrad during Fall 2018 and/or Spring 2019; (2) Students who were not engaged users during either Fall 2018 or Spring 2019. The questionnaire will ask students about their current satisfaction with their undergraduate degree experience, as well as the extent to which RadGrad was useful to them in discovering new interest areas, career goals, and extramural opportunities. For those students who are graduating, we will ask them whether they believe RadGrad has helped them become better prepared for whatever they are choosing to do after graduation.</p>


            <p style={{maxWidth: "100em"}}>The results of the questionnaire will provide evidence regarding the causal impact of RadGrad on the undergraduate degree experience. We hypothesize that engaged RadGrad users will be more satisfied with their undergraduate degree experience, and that they will have discovered new interests, career goals, and extramural opportunities through the system.</p>

            <h3>Retaining women and underrepresented minorities</h3>

            <p style={{maxWidth: "100em", padding: "0"}}></p>
